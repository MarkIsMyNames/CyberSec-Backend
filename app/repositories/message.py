...
class SQLMessageRepository:
    ...
    def store_message(
        ...
        logger.info("stored message id=%d sender_id=%d recipient_id=%d", msg_id, sender_id, recipient_id)
        return msg_id
    ...
    def delete_message(self, message_id: int, owner_field: Literal["sender_id", "recipient_id"], user_id: int) -> bool:
        owner_column = Message.sender_id if owner_field == "sender_id" else Message.recipient_id
